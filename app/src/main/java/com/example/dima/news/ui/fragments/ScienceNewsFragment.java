...
public class ScienceNewsFragment extends MvpAppCompatFragment implements CategoryNewsView{
    private static ScienceNewsFragment scienceNewsFragment = null;
    ...
    public static ScienceNewsFragment getInstance() {
        if (scienceNewsFragment == null) {
            scienceNewsFragment = new ScienceNewsFragment();
        }
        return scienceNewsFragment;
    }
