...
public class TechnologyNewsFragment extends MvpAppCompatFragment implements CategoryNewsView{
    private static TechnologyNewsFragment technologyNewsFragment = null;
    @InjectPresenter
    ...
    public static TechnologyNewsFragment getInstance() {
        if (technologyNewsFragment == null) {
            technologyNewsFragment = new TechnologyNewsFragment();
        }
